...
!(function () {
  ...
  m &&
    ((K = (b.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
      b.readyState
    )) ||
  ...
  function Jt(t) {
    return t.reduce(function (t, e) {
      ...
      if (Bt[e]) t.prefix = e;
        ...
        var a =
          'fa' === t.prefix ? Kt[n] || { prefix: null, iconName: null } : {};
  ...
  function se(t) {
    ...
    return (
      ...
      o.prefix && 1 < i.length
        ...
        : o.prefix &&
          1 === i.length &&
          (o.iconName = Xt(o.prefix, Ht(t.innerText))),
      o
    );
  }
  var le = function (t) {
          ...
          (function (t) {
            ...
            var e,
              ...
              o =
                ((n = 0),
                (r = (e = t).length),
                55296 <= (i = e.charCodeAt(n)) &&
                i <= 56319 &&
                n + 1 < r &&
                56320 <= (a = e.charCodeAt(n + 1)) &&
                a <= 57343
